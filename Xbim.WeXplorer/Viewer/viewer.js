...
var navigation_arcball_1 = require("./plugins/NavigationArcball/navigation-arcball");
...
var Viewer = /** @class */ (function () {
    ...
    */
    ...
    Object.defineProperty(Viewer.prototype, "shadowMapSize", {
        get: function () {
    ...
    */
    ...
    Viewer.prototype._initShadow = function () {
        var gl = this.gl;
    ...
    Viewer.prototype._createShadowMap = function () {
        var gl = this.gl;
        var size = this._shadowMapSize;
        gl.useProgram(this._lightShadowShaderProgram);
        gl.bindTexture(gl.TEXTURE_2D, this._shadowMapTexture);
    ...
    */
    Viewer.prototype.draw = function (frameTime) {
        ...
        switch (this.camera) {
            case 'perspective':
                mat4_1.mat4.perspective(this._pMatrix, this.perspectiveCamera.fov * Math.PI / 180.0, ratio, this.perspectiveCamera.near, this.perspectiveCamera.far);
                break;
            case 'orthogonal':
